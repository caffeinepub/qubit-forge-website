...
export class Backend implements backendInterface {
    ...
    async getAllSuggestions(): Promise<Array<SuggestionSubmission>> {
        if (this.processError) {
            try {
    ...
    async submitSuggestion(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSuggestion(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
